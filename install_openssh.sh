...
# Version: 2.0
# Last Update: 2016-03-08, Upgraded to openssh 7.2p1 so we can log
#              keys.
# New code contributed by John Walsh
#
...
wget https://raw.githubusercontent.com/wedaa/LongTail-Openssh-honeypot-v2/master/sshd_config-22
